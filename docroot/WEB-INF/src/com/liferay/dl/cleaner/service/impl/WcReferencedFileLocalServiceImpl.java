 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link com.liferay.dl.cleaner.service.WcReferencedFileLocalService} interface.
 *
 * <p>
 ...
 */
public class WcReferencedFileLocalServiceImpl
	extends WcReferencedFileLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this interface directly. Always use {@link com.liferay.dl.cleaner.service.WcReferencedFileLocalServiceUtil} to access the wc referenced file local service.
	 */
	 ...
	 */
	public WcReferencedFile addWcReferencedFile(long userId, long groupId, String dlFileUuId, String articleId, String type, boolean orphan ) throws SystemException, PortalException{
		...
		if(journalArticle == null){
			...
			resourceLocalService.addResources(journalArticle.getCompanyId(), groupId, userId > 0? userId: userLocalService.getDefaultUser(journalArticle.getCompanyId()).getUserId(),
	 ...
	 * @throws SystemException 
	 */
	public List<WcReferencedFile> getWcReferencedFilesByGroupId(long groupId, int start, int end) throws SystemException{
	 ...
	 */
	public WcReferencedFile getWcReferencedFilesByGroupAndFileUUID(long groupId, String dlFileUuId) throws SystemException, NoSuchWcReferencedFileException{
	 ...
	 * @throws NoSuchWcReferencedFileException 
	 */
	public WcReferencedFile getWcReferencedFilesByCompanyAndFileUUID(long companyId, String dlFileUuId) throws SystemException, NoSuchWcReferencedFileException{
	 ...
	 * @throws SystemException 
	 */
	public List<WcReferencedFile> getWcReferencedFilesByCompanyIdAndOrphan(long companyId, boolean orphan, int start, int end) throws SystemException{
