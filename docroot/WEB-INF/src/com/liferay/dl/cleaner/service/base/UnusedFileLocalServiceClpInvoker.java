...
public class UnusedFileLocalServiceClpInvoker {
	public UnusedFileLocalServiceClpInvoker() {
		...
		_methodName50 = "getUnusedFilesByCompanyAndState";

		_methodParameterTypes50 = new String[] { "long", "boolean", "int", "int" };

		_methodName51 = "countUnusedFilesByCompanyAndState";

		_methodParameterTypes51 = new String[] { "long", "boolean" };

		_methodName52 = "searchUnusedFilesByKeywordCompanyAndState";
		...
		_methodName53 = "countSearchUnusedFilesByKeywordCompanyAndState";

		_methodParameterTypes53 = new String[] {
				"java.lang.String", "long", "long", "boolean"
			};

		_methodName54 = "cleanUnusedFile";

		_methodParameterTypes54 = new String[] { "long", "long" };

		_methodName55 = "cleanAll";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName50.equals(name) &&
			...
			return UnusedFileLocalServiceUtil.getUnusedFilesByCompanyAndState(((Long)arguments[0]).longValue(),
				((Boolean)arguments[1]).booleanValue(),
				((Integer)arguments[2]).intValue(),
				((Integer)arguments[3]).intValue());
		}
		...
		if (_methodName51.equals(name) &&
			...
			return UnusedFileLocalServiceUtil.countUnusedFilesByCompanyAndState(((Long)arguments[0]).longValue(),
				((Boolean)arguments[1]).booleanValue());
		}

		if (_methodName52.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes52, parameterTypes)) {
			return UnusedFileLocalServiceUtil.searchUnusedFilesByKeywordCompanyAndState((java.lang.String)arguments[0],
				((Long)arguments[1]).longValue(),
				((Long)arguments[2]).longValue(),
		...
		if (_methodName53.equals(name) &&
			...
			return UnusedFileLocalServiceUtil.countSearchUnusedFilesByKeywordCompanyAndState((java.lang.String)arguments[0],
				((Long)arguments[1]).longValue(),
				((Long)arguments[2]).longValue(),
				((Boolean)arguments[3]).booleanValue());
		}
