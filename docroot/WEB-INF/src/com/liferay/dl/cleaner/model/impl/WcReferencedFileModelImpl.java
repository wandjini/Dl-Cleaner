...
public class WcReferencedFileModelImpl extends BaseModelImpl<WcReferencedFile>
	...
	public Object clone() {
		...
		wcReferencedFileImpl.setArticleId(getArticleId());
	...
	public CacheModel<WcReferencedFile> toCacheModel() {
		...
		wcReferencedFileCacheModel.articleId = getArticleId();

		String articleId = wcReferencedFileCacheModel.articleId;

		if ((articleId != null) && (articleId.length() == 0)) {
			wcReferencedFileCacheModel.articleId = null;
		}
