...
public class WcReferencedFileCacheModel implements CacheModel<WcReferencedFile>,
	...
	public WcReferencedFile toEntityModel() {
		...
		if (wcUrlTitle == null) {
			wcReferencedFileImpl.setWcUrlTitle(StringPool.BLANK);
		}
		else {
			wcReferencedFileImpl.setWcUrlTitle(wcUrlTitle);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		wcUrlTitle = objectInput.readUTF();
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		if (wcUrlTitle == null) {
			...
			objectOutput.writeUTF(wcUrlTitle);
		}
