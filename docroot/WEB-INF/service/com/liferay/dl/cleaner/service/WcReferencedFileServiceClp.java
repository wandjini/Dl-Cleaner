 ...
 * @generated
 */
public class WcReferencedFileServiceClp implements WcReferencedFileService {
	public WcReferencedFileServiceClp(InvokableService invokableService) {
	...
	public void deleteWcReferencedFile(long groupId, long wcReferencedFileId)
		...
		try {
			_invokableService.invokeMethod(_methodName3,
				...
				new Object[] { groupId, wcReferencedFileId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
