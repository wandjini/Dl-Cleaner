...
public class WcReferencedFileLocalServiceUtil {
	...
	* @throws SystemException
	*/
	public static java.util.List<com.liferay.dl.cleaner.model.WcReferencedFile> searchWcReferencedFiles(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .searchWcReferencedFiles(keywords, companyId, groupId,
			orphan, orderByCol, orderType, start, end);
	}
	...
	* @throws SystemException
	*/
	public static int countSearchWcReferencedFiles(java.lang.String keywords,
		long companyId, long groupId, boolean orphan)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .countSearchWcReferencedFiles(keywords, companyId, groupId,
			orphan);
	}
